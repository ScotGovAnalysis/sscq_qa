#########################################################################
# Name of file - 17_police_confidence_E.R
#
...
sscqyear <- sscqyear %>% 
  ...
  select(SSCQid, PolConE, LA, pooled_crim_wt, cluster) %>% 
...
PolConE <- bind_rows(sscq_year, prev_year1, prev_year4, prev_year5)
...
ggsave(filename = "Outputs/PolConE1.png", plot = PolConE1,
...
PolConE2 <- graph_plot(
  ...
  plot_title = "Police Confidence E by Year (Fairly confident)")

print(PolConE2)

ggsave(filename = "Outputs/PolConE2.png", plot = PolConE2,
       width = 200, height = 120, units = "mm")
...
PolConE3 <- graph_plot(
  ...
  plot_title = "Police Confidence E by Year (Not very confident)")

print(PolConE3)

ggsave(filename = "Outputs/PolConE3.png", plot = PolConE3,
       width = 200, height = 120, units = "mm")
...
PolConE4 <- graph_plot(
  ...
  plot_title = "Police Confidence E by Year (Not at all confident)")

print(PolConE4)

ggsave(filename = "Outputs/PolConE4.png", plot = PolConE4,
       width = 200, height = 120, units = "mm")
