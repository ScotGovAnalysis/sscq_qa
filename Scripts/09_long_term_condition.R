#########################################################################
# Name of file - 09_long_term_condition.R
#
...
sscqyear <- sscqyear %>% 
  ...
  select(SSCQid, LTCondition, LA, pooled_ind_wt, cluster) %>% 
...
LTCondition <- bind_rows(sscq_year, prev_year1, prev_year2, prev_year3)
...
saveRDS(LTCondition_table, "Outputs/LTCondition_table.rds")


# Yes
LTCondition1 <- graph_plot(
  data = LTCondition,
  var_name = "LTCondition",
  var_value = "Yes",
  plot_title = "SSCQ Respondent Long-Term Condition by Year (Yes)")

print(LTCondition1)

ggsave(filename = "Outputs/LTCondition1.png", plot = LTCondition1,
       width = 200, height = 120, units = "mm")


# No
LTCondition2 <- graph_plot(
  data = LTCondition,
  var_name = "LTCondition",
  var_value = "No",
  plot_title = "SSCQ Respondent Long-Term Condition by Year (No)")

print(LTCondition2)

ggsave(filename = "Outputs/LTCondition2.png", plot = LTCondition2,
       width = 200, height = 120, units = "mm")
